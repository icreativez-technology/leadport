...
<tr id="task_<?php echo e($task->task_id); ?>" class="task-<?php echo e($task->task_status); ?>">
    <td class="tasks_col_title td-edge">
        ...
        <span class="list-checkboxes m-l-0">
            <input type="checkbox" id="toggle_task_status_<?php echo e($task->task_id); ?>" name="toggle_task_status"
                ...
                data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/toggle-status')); ?>" data-ajax-type="post"
            ...
            <label for="toggle_task_status_<?php echo e($task->task_id); ?>">
                <a class="show-modal-button reset-card-modal-form js-ajax-ux-request" href="javascript:void(0)"
                    data-toggle="modal" data-target="#cardModal" data-url="<?php echo e(urlResource('/orders/'.$task->task_id)); ?>"
    ...
    <td class="tasks_col_my_time">
        ...
        <span
            ...
            data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/start?source=list" data-form-id="tasks-list-table"
        ...
        <span
            ...
            data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/stop?source=list" data-form-id="tasks-list-table"
            data-type="form" data-progress-bar='hidden' data-ajax-type="POST">
    ...
    <td class="tasks_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                ...
                data-url="<?php echo e(url('/')); ?>/orders/<?php echo e($task->task_id); ?>">
        ...
        <span class="list-table-action dropdown  font-size-inherit">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/clone')); ?>"
                    data-action-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/clone')); ?>" data-modal-size="modal-sm"
                ...
                <a class="dropdown-item confirm-action-danger"
                    ...
                    data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/stopall?source=list">
                ...
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/recurring-settings?source=list')); ?>"
                    data-loading-target="commonModalBody"
                    data-modal-title="<?php echo e(cleanLang(__('lang.recurring_settings'))); ?>"
                    data-action-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/recurring-settings?source=list')); ?>"
                ...
                <a class="dropdown-item confirm-action-info" href="javascript:void(0)"
                    ...
                    data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/stop-recurring?source=list')); ?>">
                ...
                <a class="dropdown-item confirm-action-info"
                    ...
                    data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-ajax-type="PUT"
                    data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/archive')); ?>">
                ...
                <a class="dropdown-item confirm-action-info"
                    ...
                    data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-ajax-type="PUT"
                    data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/activate')); ?>">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/orders/components/table/ajax.blade.php ENDPATH**/ ?>