...
<div class="x-section x-timer m-t-10" id="task-users-task-timer">
    ...
    <span
        ...
        data-url="{{ url('/') }}/orders/timer/{{ $task->task_id }}/start?source=card" data-form-id="tasks-list-table"
    ...
    <span
        ...
        data-url="{{ url('/') }}/orders/timer/{{ $task->task_id }}/stop?source=card" data-form-id="tasks-list-table"
        data-type="form" data-progress-bar='hidden' data-ajax-type="POST">
