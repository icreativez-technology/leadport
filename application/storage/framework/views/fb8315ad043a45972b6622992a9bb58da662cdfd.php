...
<ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item"> <a class="nav-link active ajax-request" data-toggle="tab" href="javascript:void(0);"
                        role="tab" data-url="<?php echo e(url('orders/content/'.$task->task_id.'/show-main?show=tab')); ?>"
...
<?php endif; ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/content/tabmenu.blade.php ENDPATH**/ ?>