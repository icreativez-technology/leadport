<div class="x-section">
    ...
    <div id="card-tags-edit-tags-container" class="hidden">
        ...
        <div id="card-edit-tags-buttons" class="p-t-10 hidden text-right display-block">
            ...
            <button type="button" class="btn waves-effect waves-light btn-xs btn-danger ajax-request"
                data-url="<?php echo e(url('orders/'.$task->task_id.'/update-tags')); ?>" data-progress-bar="hidden"
    ...
    <?php endif; ?>
</div><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/tags.blade.php ENDPATH**/ ?>