...
<div class="x-section x-timer m-t-10" id="task-users-task-timer">
    ...
    <span
        ...
        data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/start?source=card" data-form-id="tasks-list-table"
    ...
    <span
        ...
        data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/stop?source=card" data-form-id="tasks-list-table"
        data-type="form" data-progress-bar='hidden' data-ajax-type="POST">
...
<?php endif; ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/timer.blade.php ENDPATH**/ ?>