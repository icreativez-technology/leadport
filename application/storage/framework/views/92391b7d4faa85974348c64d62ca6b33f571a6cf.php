<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>"
    ...
    <div class="col-lg-12">
        ...
        <!--client<>-->
        <?php if(config('visibility.project_modal_client_fields')  && auth()->user()->role_id == 1): ?>
        ...
        <?php endif; ?>
    </div><?php /**PATH /var/www/html/application/resources/views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>