    ...
    <div class="x-section">
        ...
        <span id="task-assigned-container" class="">
            @include('pages.order.components.assigned')
        </span>
        <!--user-->
    ...
    <div id="task-timer-container">
        @include('pages.order.components.timer')
    </div>
    ...
    <div class="x-section">
        ...
        <div class="x-element" id="task-due-date"><i class="mdi mdi-calendar-clock"></i>
            ...
            <span class="x-highlight x-editable card-pickadate"
                data-url="{{ urlResource('/orders/'.$task->task_id.'/update-due-date/') }}" data-type="form"
        ...
        <div class="x-element" id="card-task-client"><i class="mdi mdi-eye"></i>
            ...
            <button type="button" class="btn btn-danger btn-sm" id="card-task-update-client-button"
                data-progress-bar='hidden' data-url="{{ url('/orders/'.$task->task_id.'/update-client') }}"
    ...
    <div class="card-tags-container" id="card-tags-container">
        @include('pages.order.components.tags')
    </div>
    @endif
    ...
    <div class="x-section">
        ...
        @include('pages.order.dependency.wrapper')
    </div>
    ...
    <div class="x-section">
        ...
        <div class="x-element x-action confirm-action-danger"
            ...
            data-url="{{ url('/') }}/orders/timer/{{ $task->task_id }}/stopall?source=card"><i
        ...
        <div class="x-element x-action confirm-action-info  {{ runtimeActivateOrAchive('archive-button', $task->task_active_state) }} card_archive_button_{{ $task->task_id }}"
            ...
            data-url="{{ url('/') }}/orders/{{ $task->task_id }}/archive"><i class="mdi mdi-archive"></i> <span
        ...
        <div class="x-element x-action confirm-action-info  {{ runtimeActivateOrAchive('activate-button', $task->task_active_state) }} card_restore_button_{{ $task->task_id }}"
            ...
            data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}" data-ajax-type="PUT"
            data-url="{{ url('/') }}/orders/{{ $task->task_id }}/activate"><i class="mdi mdi-archive"></i> <span
        ...
        <div class="x-element x-action confirm-action-danger"
            ...
            data-url="{{ urlResource('/') }}/orders/{{ $task->task_id }}"><i class="mdi mdi-delete"></i> <span
