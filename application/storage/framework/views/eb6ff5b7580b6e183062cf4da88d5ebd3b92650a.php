<div class="board">
    <div class="board-body <?php echo e(runtimeKanbanBoardColors($board['color'])); ?>">
        <div class="board-heading clearfix">
            ...
            <div class="pull-right x-action-icons">
                ...
                <span class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form cursor-pointer"
                    ...
                    data-url="<?php echo e(urlResource('/orders/create?status='.$board['id'])); ?>"
                    data-loading-target="commonModalBody" data-modal-title="<?php echo e(cleanLang(__('lang.add_task'))); ?>"
                    data-action-url="<?php echo e(urlResource('/orders?type=kanban')); ?>" data-action-method="POST"
        ...
        <div class="content kanban-content" id="kanban-board-wrapper-<?php echo e($board['id']); ?>" data-board-name="<?php echo e($board['id']); ?>">
            ...
            <?php echo $__env->make('pages.orders.components.kanban.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>

            <!-- dynamic load more button-->
            <?php echo $__env->make('pages.orders.components.kanban.loadmore-button', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/orders/components/kanban/board.blade.php ENDPATH**/ ?>