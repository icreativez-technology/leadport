            ...
            <div class="col-sm-6 x-meta text-right">
                ...
                <span class="comment-actions"> |
                    <a href="javascript:void(0)" class="js-delete-ux-confirm confirm-action-danger text-danger"
                        ...
                        data-url="<?php echo e(urlResource('/orders/delete-comment/'.$comment->comment_id)); ?>">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/comment.blade.php ENDPATH**/ ?>