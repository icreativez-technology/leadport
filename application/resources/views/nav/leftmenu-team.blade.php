        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <li data-modular-id="main_menu_team_orders"
                    class="sidenav-menu-item {{ $page['mainmenu_orders'] ?? '' }}">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false">
                        <i class="ti-menu-alt"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.orders')) }}
                        </span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li class="sidenav-submenu {{ $page['submenu_orders'] ?? '' }}" id="submenu_clients">
                            <a href="{{url('orders')}}"
                                class="{{ $page['submenu_orders'] ?? '' }}">{{ cleanLang(__('lang.orders')) }}</a>
                        </li>
                        <li class="sidenav-submenu {{ $page['submenu_orders'] ?? '' }}" id="submenu_contacts">
                            <a href="{{url('orders')}}"
                                class="{{ $page['submenu_orders'] ?? '' }}">{{ cleanLang(__('lang.requests')) }}</a>
                        </li>
                    </ul>
                </li>
