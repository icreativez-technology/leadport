...
class UpdateLockedResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $jsondata['notification'] = [
            'type' => 'force-error',
            'value' => __('lang.order_action_permission_error'),
        ];
        ...
        $jsondata['dom_html'][] = [
            ...
            'action' => 'replace',
            'value' => runtimeLang($order->orderstatus_title),
        ];
        ...
        if (auth()->user()->pref_view_orders_layout == 'kanban') {
            ...
            $jsondata['dom_visibility'][] = [
                'selector' => '#card_order_' . $order->task_id,
                'action' => 'hide-remove',
            ];

            //return to original board
            $jsondata['dom_html_end'][] = [
                'selector' => '#kanban-board-wrapper-' . $order->task_status,
                'action' => 'prepend',
                'value' => $html,
            ];
        }
