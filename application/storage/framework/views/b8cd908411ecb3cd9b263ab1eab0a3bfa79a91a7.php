    ...
    <div class="x-section">
        ...
        <span id="task-assigned-container" class="">
            <?php echo $__env->make('pages.order.components.assigned', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </span>
        <!--user-->
    ...
    <div id="task-timer-container">
        <?php echo $__env->make('pages.order.components.timer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    ...
    <div class="x-section">
        ...
        <div class="x-element" id="task-due-date"><i class="mdi mdi-calendar-clock"></i>
            ...
            <span class="x-highlight x-editable card-pickadate"
                data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/update-due-date/')); ?>" data-type="form"
        ...
        <div class="x-element" id="card-task-client"><i class="mdi mdi-eye"></i>
            ...
            <button type="button" class="btn btn-danger btn-sm" id="card-task-update-client-button"
                data-progress-bar='hidden' data-url="<?php echo e(url('/orders/'.$task->task_id.'/update-client')); ?>"
    ...
    <div class="card-tags-container" id="card-tags-container">
        <?php echo $__env->make('pages.order.components.tags', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <?php endif; ?>
    ...
    <div class="x-section">
        ...
        <?php echo $__env->make('pages.order.dependency.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    ...
    <div class="x-section">
        ...
        <div class="x-element x-action confirm-action-danger"
            ...
            data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/stopall?source=card"><i
        ...
        <div class="x-element x-action confirm-action-info  <?php echo e(runtimeActivateOrAchive('archive-button', $task->task_active_state)); ?> card_archive_button_<?php echo e($task->task_id); ?>"
            ...
            data-url="<?php echo e(url('/')); ?>/orders/<?php echo e($task->task_id); ?>/archive"><i class="mdi mdi-archive"></i> <span
        ...
        <div class="x-element x-action confirm-action-info  <?php echo e(runtimeActivateOrAchive('activate-button', $task->task_active_state)); ?> card_restore_button_<?php echo e($task->task_id); ?>"
            ...
            data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-ajax-type="PUT"
            data-url="<?php echo e(url('/')); ?>/orders/<?php echo e($task->task_id); ?>/activate"><i class="mdi mdi-archive"></i> <span
        ...
        <div class="x-element x-action confirm-action-danger"
            ...
            data-url="<?php echo e(urlResource('/')); ?>/orders/<?php echo e($task->task_id); ?>"><i class="mdi mdi-delete"></i> <span
...
</script><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/rightpanel.blade.php ENDPATH**/ ?>