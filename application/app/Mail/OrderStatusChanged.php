...
/** --------------------------------------------------------------------------------
 * This classes renders the [order status changed] email and stores it in the queue
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class OrderStatusChanged extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'order Status Change')->first()) {
            return false;
        }
        ...
        $payload += [
            ...
            'order_created_date' => runtimeDate($this->obj->order_created_date),
