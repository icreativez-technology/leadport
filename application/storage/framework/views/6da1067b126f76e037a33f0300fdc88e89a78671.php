<head>
    ...
    <script src="livecrm/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>
    ...
    <link rel="stylesheet" href="livecrm/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">
    <link rel="stylesheet" href="livecrm/public/vendor/fonts/growcrm-icons/styles.css?v=<?php echo e(config('system.versioning')); ?>">
    <link href="livecrm/public/themes/default/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php if(auth()->check()): ?>
    <link
        href="livecrm/public/themes/<?php echo e(auth()->user()->pref_theme); ?>/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php else: ?>
    <link href="<?php echo e(config('theme.selected_theme_css')); ?> " rel="stylesheet">
    <?php endif; ?>
    
    <link href="livecrm/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    <link href="livecrm/public/css/print.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="livecrm/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
</head><?php /**PATH E:\xampp\htdocs\livesoft\livecrm\application\resources\views/layout/header.blade.php ENDPATH**/ ?>