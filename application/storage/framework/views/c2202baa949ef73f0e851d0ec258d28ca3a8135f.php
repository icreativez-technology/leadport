<div class="card-description" id="card-description">
    ...
    <div id="card-description-submit" class="p-t-10 hidden text-right">
        ...
        <button type="button" class="btn waves-effect waves-light btn-xs btn-danger js-description-save"
            data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/update-description')); ?>" data-progress-bar='hidden'
    ...
    <?php endif; ?>
</div><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/description.blade.php ENDPATH**/ ?>