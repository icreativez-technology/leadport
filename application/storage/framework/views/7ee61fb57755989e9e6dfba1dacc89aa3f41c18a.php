...
<div id="card-title-edit" class="card-title-edit hidden">
    ...
    <div id="card-title-submit" class="p-t-10 text-right">
        ...
        <button type="button" class="btn waves-effect waves-light btn-xs btn-danger"
            data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/update-title')); ?>" data-progress-bar='hidden'
...
<?php endif; ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/title.blade.php ENDPATH**/ ?>