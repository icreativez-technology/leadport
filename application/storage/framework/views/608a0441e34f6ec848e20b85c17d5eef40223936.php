...
<div id="task_dependency_task_<?php echo e($dependency->tasksdependency_id); ?>"
    ...
    <span><a href="<?php echo e(url('/orders/v/'.$dependency->task_id)); ?>" target="_blank"><?php echo e($dependency->task_title); ?></a></span>
    ...
    <span class="task-dependency-delete-button ajax-request" id="task-dependency-delete-button" data-parent="task_dependency_task_<?php echo e($dependency->tasksdependency_id); ?>"
        data-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/delete-dependency?dependency_id='.$dependency->tasksdependency_id)); ?>" data-ajax-type="DELETE"
...
<?php endif; ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/dependency/ajax.blade.php ENDPATH**/ ?>