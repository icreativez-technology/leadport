...
<div class="kanban-card kanban-board-element show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    data-target="#cardModal" data-url="<?php echo e(urlResource('/orders/'.$task->task_id)); ?>" data-task-id="<?php echo e($task->task_id); ?>"
    ...
    <div class="x-title wordwrap" id="kanban_task_title_<?php echo e($task->task_id); ?>"><?php echo e($task->task_title); ?>
        ...
        <div class="dropdown-menu dropdown-menu-small dropdown-menu-right js-stop-propagation"
            ...
            <a class="dropdown-item confirm-action-danger  js-stop-propagation"
                ...
                data-url="<?php echo e(url('/')); ?>/orders/<?php echo e($task->task_id); ?>"><?php echo e(cleanLang(__('lang.delete'))); ?></a>
            <?php $count_actions ++ ; ?>
            <?php endif; ?>
            ...
            <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                ...
                data-action-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/clone')); ?>" data-modal-size="modal-lg"
            ...
            <a class="dropdown-item confirm-action-danger js-stop-propagation"
                ...
                data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/stop"><?php echo e(cleanLang(__('lang.stop_my_timer'))); ?></a>
            <?php $count_actions ++ ; ?>
            <?php endif; ?>
            <!--stop all timers-->
            ...
            <a class="dropdown-item confirm-action-danger js-stop-propagation"
                ...
                data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-ajax-type="GET"
                data-url="<?php echo e(url('/')); ?>/orders/timer/<?php echo e($task->task_id); ?>/stopall?source=list"><?php echo e(cleanLang(__('lang.stop_all_timers'))); ?></a>
            <?php $count_actions ++ ; ?>
            <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/orders/components/kanban/card.blade.php ENDPATH**/ ?>