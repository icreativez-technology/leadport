...
<div class="col-sm-12" id="card_attachment_<?php echo e($attachment->attachment_uniqiueid); ?>">
    <div class="file-attachment">
        ...
        <?php else: ?>
        <div class="x-image"> 
            <a class="preview-image-thumb" href="orders/download-attachment/<?php echo e($attachment->attachment_uniqiueid); ?>" download>
        ...
        <div class="x-details">
            ...
            <div class="x-actions"><strong>
                    <!--action: download-->
                    <a href="orders/download-attachment/<?php echo e($attachment->attachment_uniqiueid); ?>" download><?php echo e(cleanLang(__('lang.download'))); ?> <span
                ...
                <span> |
                    <a href="javascript:void(0)" class="text-danger js-delete-ux-confirm confirm-action-danger"
                        ...
                        data-url="<?php echo e(urlResource('/orders/delete-attachment/'.$attachment->attachment_uniqiueid)); ?>"><?php echo e(cleanLang(__('lang.delete'))); ?></a></span>
                <?php endif; ?>
            </div>
        </div>
    </div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/attachment.blade.php ENDPATH**/ ?>