...
<form class="form" id="settingsFormEmailGeneral">
    ...
    <div class="text-right">
        ...
        <button type="submit" id="commonModalSubmitButton" class="btn btn-rounded-x btn-danger waves-effect text-left"
            data-url="<?php echo e(url('settings/email/general')); ?>" data-loading-target="" data-ajax-type="PUT" data-type="form"
            data-on-start-submit-button="disable"><?php echo e(cleanLang(__('lang.save_changes'))); ?></button>

    </div>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\livesoft\leadport\application\resources\views/pages/settings/sections/email/general.blade.php ENDPATH**/ ?>