...
<div class="checklist-item clearfix" id="task_checklist_container_<?php echo e($checklist->checklist_id); ?>"
    ...
    <input type="checkbox" class="filled-in chk-col-light-blue js-ajax-ux-request-default" name="card_checklist" data-progress-bar='hidden'
        data-url="<?php echo e(urlResource('/orders/toggle-checklist-status/'.$checklist->checklist_id)); ?>" data-ajax-type="post"
    ...
    <span class="checklist-text <?php echo e(runtimePermissions('task-edit-checklist', $checklist->permission_edit_delete_checklist)); ?>" data-toggle="edit" data-id="<?php echo e($checklist->checklist_id); ?>"
        data-action-url="<?php echo e(urlResource('/orders/update-checklist/'.$checklist->checklist_id)); ?>"><?php echo e($checklist->checklist_text); ?></span>
    <!--delete action-->
    ...
    <a href="javascript:void(0)" class="x-action-delete checklist-item-delete hidden js-delete-ux js-ajax-ux-request"
        ...
        data-progress-bar="hidden" data-url="<?php echo e(urlResource('/orders/delete-checklist/'.$checklist->checklist_id)); ?>"><i
            class="mdi mdi-delete text-danger"></i></a>
   <?php endif; ?>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/checklist.blade.php ENDPATH**/ ?>