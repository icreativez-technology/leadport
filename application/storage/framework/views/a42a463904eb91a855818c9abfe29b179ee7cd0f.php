    ...
    <div class="x-section">
        ...
        <div class="x-element" id="task-due-date"><i class="mdi mdi-calendar-clock"></i>
            ...
            <div mbsc-page class="demo-week-select">
                ...
                <div id="demo-week-select"><?php echo e(runtimeDate($task->task_date_start)); ?></div>
                </div>
            </div>
...
<?php /**PATH E:\xampp\htdocs\livesoft\livecrm\application\resources\views/pages/task/rightpanel.blade.php ENDPATH**/ ?>