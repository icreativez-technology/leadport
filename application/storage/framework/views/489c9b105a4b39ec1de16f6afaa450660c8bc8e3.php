<div class="card-checklist" id="card-checklist">
    ...
    <div class="x-action">
        <a href="javascript:void(0)" class="js-card-checklist-toggle" id="card-checklist-add-new"
            data-action-url="<?php echo e(urlResource('/orders/'.$task->task_id.'/add-checklist')); ?>" data-toggle="new"><?php echo e(cleanLang(__('lang.add_new_item'))); ?></a>
    </div>
    <?php endif; ?>
</div><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/components/checklists.blade.php ENDPATH**/ ?>