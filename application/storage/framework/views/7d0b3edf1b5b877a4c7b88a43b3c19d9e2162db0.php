...
<div class="form-data-row-buttons">
    <button type="button" class="btn waves-effect waves-light btn-xs btn-info ajax-request float-left"
        data-url="<?php echo e(url('orders/content/'.$task->task_id.'/edit-customfields')); ?>"
...
<?php endif; ?>
</div><?php /**PATH F:\xampp\htdocs\icreativez\livesoft\leadport\application\resources\views/pages/order/content/customfields/show.blade.php ENDPATH**/ ?>