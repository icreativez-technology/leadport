...
return [
    ...
    'order_has_been_sent' => "Order successfully sent to Docport",
    'order_has_been_failed' => "Order can't send something is wrong please try again latter",
    ...
    'show_archive_orders' => "Show Archived Orders",
