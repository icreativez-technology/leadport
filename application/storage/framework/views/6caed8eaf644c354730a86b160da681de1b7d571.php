<head>
    ...
    <script src="leadport/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>
    ...
    <link rel="stylesheet" href="leadport/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">
    <link rel="stylesheet" href="leadport/public/vendor/fonts/growcrm-icons/styles.css?v=<?php echo e(config('system.versioning')); ?>">
    <link href="leadport/public/themes/default/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php if(auth()->check()): ?>
    <link
    ...
    <link href="leadport/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    <link href="leadport/public/css/print.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="leadport/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
</head><?php /**PATH E:\xampp\htdocs\livesoft\leadport\application\resources\views/layout/header.blade.php ENDPATH**/ ?>