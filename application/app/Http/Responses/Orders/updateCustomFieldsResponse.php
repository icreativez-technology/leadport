...
class updateCustomFieldsResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //json output
        $html = view('pages/order/components/custom-fields', compact('task', 'fields'))->render();
        $jsondata['dom_html'][] = [
        ...
        //json output
        $html = view('pages/order/components/custom-fields-edit', compact('task', 'fields'))->render();
        $jsondata['dom_html'][] = [
