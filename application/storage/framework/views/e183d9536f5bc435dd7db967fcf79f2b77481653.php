    ...
    <div class="col-lg-12">
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                ...
                <span><input type="text" class="form-control pickadate task-extra"  name="from_date" placeholder="from"></span>
                <span><input type="time" class="task-extra"  name="from_time"></span>
                --
                <span><input type="time" class="task-extra"  name="to_time"></span>
                <span><input type="text" class="form-control pickadate task-extra" name="to_date" placeholder="to"></span>
            </div>
...
</script><?php /**PATH E:\xampp\htdocs\livesoft\leadport\application\resources\views/pages/tasks/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>